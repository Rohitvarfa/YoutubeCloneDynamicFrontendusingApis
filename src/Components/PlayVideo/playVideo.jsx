...
import jack from '../../assets/Rohit1.png.jpg'
...
const fetchOtherData = async () =>{
  ...
  await fetch(comment_url).then(response=>response.json()).then(data=>setCommentData(data.item))
}
  ...
  return (
    <div className='play-video'>
        ...
        <div className="play-video-info">
          <p>{apiData?value_converter(apiData.statistics.viewCount):"16K"} Views  &bull; {moment(apiData?apiData.snippet.publishedAt:"1 day ago").fromNow()}  </p>
          <div>
